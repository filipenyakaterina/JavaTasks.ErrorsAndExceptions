...
public class Runner {
    private final static AcademicSubject ACADEMIC_SUBJECT_FOR_TEST = AcademicSubject.PHILOSOPHY;
    ...
    private static void getAverageGradesOfFaculties(University university) throws UniversityWithoutFacultiesException, StudentWithoutAcademicSubjectsException,
    ...
    private static void getAverageGradesOfGroups(University university) throws UniversityWithoutFacultiesException, StudentWithoutAcademicSubjectsException,
    ...
    private static void getAverageGradeOfUniversity(University university) throws UniversityWithoutFacultiesException, StudentWithoutAcademicSubjectsException,
            FacultyWithoutGroupsException, GroupWithoutStudentsException {
    ...
    private static void getExceptions(University university) throws FacultyWithoutGroupsException, UniversityWithoutFacultiesException,
        ...
        switch (programNumber){
            case 1:
                ...
                studentWithGradeOutOfRange.setGrade(AcademicSubject.PHILOSOPHY,incorrectGrade);
                System.out.println(studentWithGradeOutOfRange);
                break;
            case 2:
                System.out.println("Отсутсвие предметов у студента (должен быть хотя бы один)");
                Student studentWithoutSubjects = new Student("Lev","Lvov", EnumSet.noneOf(AcademicSubject.class));
            ...
            case 3:
                ...
                System.out.println(UniversityAction.getAverageGradeOfGroup(university,groupWithoutStudents, AcademicSubject.ENGLISH));
                break;
            case 4:
                ...
                System.out.println(UniversityAction.getAverageGradeOfFaculty(university,facultyWithoutGroups, AcademicSubject.ENGLISH));
                break;
            case 5:
